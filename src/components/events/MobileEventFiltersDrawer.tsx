...
interface MobileEventFiltersDrawerProps {
  state: EventFiltersState
}

export function MobileEventFiltersDrawer({
  state,
}: MobileEventFiltersDrawerProps) {
  ...
  return (
    <>
      ...
      >
        <EventFilters state={state} onNavigate={() => setOpen(false)} />
      </Drawer>
    </>
  )
}
